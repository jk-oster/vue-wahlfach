...
<template>
  ...
  <section class="flex flex-col gap-2">
    ...
    <label class="input validator">
      ...
      <input v-model="email" type="input" required placeholder="Username" pattern="[A-Za-z][A-Za-z0-9\-]*" minlength="3" maxlength="30" title="Only letters, numbers or dash" />
    </label>
    ...
    <RouterLink to="/chat" v-bind:disabled="!email || !password">
      <button @click="handleLogin" class="btn btn-active btn-primary">Login</button>
    </RouterLink>
  </section>
